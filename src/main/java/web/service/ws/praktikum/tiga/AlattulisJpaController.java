...
import web.service.ws.praktikum.tiga.exceptions.NonexistentEntityException;
import web.service.ws.praktikum.tiga.exceptions.PreexistingEntityException;
...
public class AlattulisJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("web.service_ws.praktikum.tiga_jar_0.0.1-SNAPSHOTPU");
